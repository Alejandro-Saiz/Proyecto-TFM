...
Datos = pd.read_csv('Resultados_CSV.csv')

dat_y = Datos['Order']
dat_x = Datos.drop('Order',axis = 1)

x_train, x_test, y_train, y_test = train_test_split(dat_x, dat_y, 
                                                    test_size = 0.5, 
                                                    random_state=0)

logmodel = LogisticRegression(fit_intercept=False, C=2000, solver='liblinear', random_state=0)

logmodel.fit(x_train,y_train)
y_pred = logmodel.predict(x_test) #predicting test results
# ***********************************************************************************************************************
